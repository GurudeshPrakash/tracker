...
export const ActiveLearningBento: React.FC<ActiveLearningBentoProps> = ({
  ...
  // Real working study stopwatch
  const [seconds, setSeconds] = useState<number>(2912); // Default to 48m 32s as in concept image
  ...
  const activeTopic = recentSessions[0]?.skill || 'Advanced React Hooks';
  ...
  return (
    ...
    >
      <div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
          <div>
            ...
            <div style={{ fontSize: '0.82rem', color: '#94a3b8', marginTop: '0.2rem' }}>
              Learning: <span style={{ color: '#ec4899', fontWeight: '700' }}>{activeTopic}</span>
            </div>
          </div>
          <button
        ...
        {/* Study Timer Section matching image */}
        <div style={{ margin: '1.5rem 0', textAlign: 'center' }}>
          <div style={{ fontSize: '0.75rem', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.08em', color: '#94a3b8', marginBottom: '0.5rem' }}>
            Study Timer
          </div>
